...
public class JFrameConversor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLayeredPane1.setBorder(javax.swing.BorderFactory.createTitledBorder("Conversor de ano?"));

        jlYear.setText("Insira um ano");

        jtYear.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jtYearKeyPressed(evt);
            }
        });
        ...
        jLayeredPane1.setLayer(jtYear, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane1Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane1Layout.createSequentialGroup()
                .addGroup(jLayeredPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jLayeredPane1Layout.createSequentialGroup()
                        .addGap(144, 144, 144)
                        .addComponent(jlYear, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jLayeredPane1Layout.createSequentialGroup()
                        .addGap(136, 136, 136)
                        .addGroup(jLayeredPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jbSubmit)
                            .addComponent(jtYear, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void register(){
        ...
        con.setYear(Integer.parseInt(jtYear.getText()));
        
        JOptionPane.showMessageDialog(this, con.toString(), "Relatório", JOptionPane.PLAIN_MESSAGE);
    }
    ...
    private void jtYearKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtYearKeyPressed
        if (evt.getKeyCode()==KeyEvent.VK_ENTER){
            register();
            clean();
        }
    }//GEN-LAST:event_jtYearKeyPressed
